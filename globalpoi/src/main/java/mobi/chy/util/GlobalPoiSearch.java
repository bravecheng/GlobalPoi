...
public class GlobalPoiSearch {
    ...
    public GlobalPoiSearch(Context context, double lat, double lng) {
        this(context, lat, lng, 5000);
    }

    public GlobalPoiSearch(Context context, double lat, double lng, int radius) {
